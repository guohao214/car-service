...
;(function () {
  ...
  // api接口请求地址 
  window.SITE_CONFIG['baseUrl_pc'] = 'http://www.maixc.cn';
  window.SITE_CONFIG['baseUrl_admin'] = 'http://www.maixc.cn';
  window.SITE_CONFIG['baseUrl_Swoole'] = 'http://www.maixc.cn';
  window.SITE_CONFIG['baseUrl_Spring'] = 'http://www.maixc.cn';
  window.SITE_CONFIG['mqtt_server'] = 'http://www.maixc.cn';


  // cdn地址 = 域名 + 版本号
  window.SITE_CONFIG['domain']  = './'; // 域名
  window.SITE_CONFIG['version'] = '1907201138';   // 版本号(年月日时分)
